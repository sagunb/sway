...
impl<'ir> AsmBuilder<'ir> {
    ...
    fn compile_asm_block(
        ...
        for op in &asm_block.body {
            ...
            inline_ops.push(Op {
                ...
                owning_span: Some(op.get_span(self.context)),
            });
        }
        ...
        if let Some(ret_reg_name) = &asm_block.return_name {
            ...
            inline_ops.push(Op::register_move_comment(
                instr_reg.clone(),
                ret_reg,
                instr_val.get_span(self.context),
    ...
    fn compile_extract_element(
        ...
        if elem_size <= 8 {
            self.bytecode.push(Op {
                ...
                owning_span: Some(instr_val.get_span(self.context)),
            });
                        ...
                        match &constant.value {
                            ...
                            | ConstantValue::String(_) => {
                                ...
                                self.bytecode.push(Op {
                                    ...
                                    owning_span: Some(value.get_span(self.context)),
                                });
    ...
    fn number_to_reg(&mut self, offset: u64, offset_reg: &VirtualRegister, span: Span) {
